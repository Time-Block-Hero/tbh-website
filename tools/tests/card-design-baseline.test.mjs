...
test('frozen rulebook bytes are bound to the same design revision', () => {
  ...
  for (const [path, expected] of Object.entries(revision.rulesSha256)) assert.equal(hash(read(path)), expected, path);
});
