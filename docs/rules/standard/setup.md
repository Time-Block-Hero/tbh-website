...
**STD-007 标准双人棋盘为纵向 14 行、横向 7 列。** 本章以固定俯视方向从上到下编号第 1–14 行、从左到右编号第 1–7 列；编号不随玩家视角翻转。卡文中的前方、上方和箭头朝向仍按[空间关系](../common/elements.md#棋盘与空间关系)解释。

**每名玩家拥有一块 5×5 领土（已确认）。** 保留外围一格与中央两行无归属的对称布局；A 玩家从下方向上，B 玩家从上方向下。整盘 14×7 是配合本次领土缩小采用的布局默认值，见[修订来源](../maintenance/sources.md#标准对战审阅修订)。

| 区域 | 固定棋盘坐标 |
| --- | --- |
| A 玩家领土 | 第 9–13 行，第 2–6 列 |
| B 玩家领土 | 第 2–6 行，第 2–6 列 |
| 无玩家领土归属的区域 | 外围一圈，以及中央第 7–8 行 |

领土属于格子，不因随从移动经过或占据它就自动改变。本章所称领土与卡牌当前归属分别判断；领土影响普通放置与资源生成，具体行动合法性仍见[第四章](../common/actions.md)。

### 10.3.2 英雄部署

**STD-008 玩家在己方领土最后一排的合法空格中选择英雄起点。** 按上述地图，A 可选择第 13 行第 2–6 列，B 可选择第 2 行第 2–6 列。
